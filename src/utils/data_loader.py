...
class DataLoader():
    ...
    def preprocess_and_word2vec(self, emb_dim):
        ...
        token_list = ['PAD_token', 'UNK_token', 'END_token', 'count_0', 'count_1', 'count_2', 'count_3', 'count_4', 'count_5', 
    ...
    def _data_batch_preprocess(self, data_batch, template_flag):
        ...
        for elem in data_batch:
            ...
            if template_flag == True:
                if self.args.post_flag == False:
                    decode_sen = self.convert(elem['target_template'][2:])
                else:
                    decode_sen = self.convert(elem['target_norm_post_template'][2:])
                #pdb.set_trace()
                #print decode_sen
                #try:
        ...
        batch_data_dict['batch_buffer'] = batch_buffer
